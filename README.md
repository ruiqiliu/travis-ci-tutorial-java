[![Build Status](https://travis-ci.com/ruiqiliu/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.com/ruiqiliu/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/ruiqiliu/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/ruiqiliu/travis-ci-tutorial-java)
...
- Add your repository (you can go there directly by going to https://codecov.io/gh/ruiqiliu/travis-ci-tutorial-java)
